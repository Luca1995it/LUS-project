...
\maketitle
\begin{abstract}
This document contains the instructions to prepare, implement and test a simple NLU system, who has to classify each word of a sentence to the corresponding IOB notation. The core of the program is powered by the Open-Source libraries OpenFST and OpenGRM. \cite{Gusfield:97,Aho:72}  \end{abstract}
